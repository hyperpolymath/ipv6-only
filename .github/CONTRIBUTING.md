...
`test`: Tests - `refactor`: Code refactoring - `perf`: Performance
improvement - `style`: Code style/formatting - `chore`: Maintenance
...
Aim for: - Core functionality: 95%+ coverage - Utilities: 90%+
coverage - CLI tools: 80%+ coverage
...
3.  \*Update **init**.py\* to export new functionality
